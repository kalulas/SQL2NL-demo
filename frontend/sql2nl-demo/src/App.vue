...
export default {
  data() {
    return {
      ...
      inputPlaceholder: "在此处输入需要翻译的SQL...",
      goldInputPlaceholder: "在此处输入参考翻译结果...（可选，填写后输出评分）",
      outputPlaceholder: "模型翻译结果会显示在这里...",
      inputValue: "",
      outputValue: "",
      goldInputValue: "",
      selectedDatabase: "",
...
<template>
  ...
  <div class="content-item">
    <label class="content-item-title article-content-text">模型</label>
  ...
  <div class="content-item">
    <label class="content-item-title article-content-text">数据库</label>
    <CascadingDropdown :dropdownItems="db_ids" @dropdownItemSelected="onDatabaseSelected"/>
  </div>
  <div class="content-item">
    <label class="content-item-title article-content-text">SQL</label>
  ...
  <div class="content-item">
    <label class="content-item-title article-content-text">参考翻译结果</label>
  ...
  <div class="content-item">
    <label class="content-item-title article-content-text">模型翻译结果</label>
